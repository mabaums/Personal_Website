...
export class ClientService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getTeam(team_id?: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public getTeam(team_id?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public getTeam(team_id?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public getTeam(team_id?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('get',`${this.basePath}/team`,
            {
